...
$Conf{ArchiveEnc} = 'none';
$Conf{ArchiveEncKey} = '';

$Conf{EncPath} = '/usr/bin/gpg2';
$Conf{GpgHomeDir} = '/home/backuppc/.gnupg';
$Conf{GpgCipherAlgo} = 'AES256';
$Conf{GpgDigestAlgo} = 'SHA512';
$Conf{GpgS2kDigestAlgo} = 'SHA512';
